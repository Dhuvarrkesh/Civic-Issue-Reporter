...
const SignUp = () => {
  ...
  const handleCitizenSignUp = async (e: React.FormEvent) => {
    ...
    try {
      // Use AuthContext.register to perform signup and set auth state
      await register(
        {
      ...
      toast.success("Registration Successful! Signed in.");
      navigate("/citizen");
    } catch (error: any) {
  ...
  const handleAdminSignUp = async (e: React.FormEvent) => {
    ...
    try {
      // Use AuthContext.register to perform admin signup and set auth
      await register(
        {
          ...
          inviteCode: adminForm.inviteCode?.trim() || undefined,
        },
        "admin"
      );

      toast.success("Admin Registration Successful! Signed in.");
      navigate("/admin");
    } catch (error: any) {
                      ...
                      <form onSubmit={handleAdminSignUp} className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            id="invite-code"
                            type="text"
                            placeholder="Enter invite code for Level-2 admin"
                            value={adminForm.inviteCode}
                            onChange={(e) =>
                              setAdminForm({
                                ...adminForm,
                          ...
                          />
                          <p className="text-sm text-muted-foreground">If you have an invite code for creating a Level-2 admin, enter it here.</p>
                        </div>
                        <div className="space-y-2">
